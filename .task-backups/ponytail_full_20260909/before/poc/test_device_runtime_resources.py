...
from test_support.web_platform import (
    _BaseDeviceCameraCoordinatorTests,
    _BaseDeviceControllerRegistryTests,
    _BaseDeviceRuntimeResourceRegistryTests,
)


class DeviceControllerRegistryTests(_BaseDeviceControllerRegistryTests):
...
class DeviceCameraCoordinatorTests(_BaseDeviceCameraCoordinatorTests):
...
class DeviceRuntimeResourceRegistryTests(_BaseDeviceRuntimeResourceRegistryTests):
