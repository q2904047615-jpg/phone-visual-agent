...
class _BaseLowLevelInputTests(unittest.TestCase):
    pass


class _BaseDeviceControllerRegistryTests(unittest.TestCase):
    pass


class _BaseDeviceCameraCoordinatorTests(unittest.TestCase):
    pass


class _BaseDeviceRuntimeResourceRegistryTests(unittest.TestCase):
    pass


class _BaseAdbKeyboardCompositionTests(unittest.TestCase):
    pass
