...
def load_vision_model_config(*, model: str | None=None, base_url: str | None=None, enable_thinking: bool=False,
    ...
    resolved_base_url = base_url or values.get('VISION_MODEL_BASE_URL') or DEFAULT_VISION_BASE_URL
    return VisionModelConfig(model=resolved_model, base_url=resolved_base_url, enable_thinking=bool(enable_thinking))
