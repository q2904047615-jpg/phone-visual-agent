...
from agent.domain.text_transport import TextTransportActionScope
...
def _action_request(value: Mapping[str, Any]) -> DeviceActionRequest:
    ...
    request = DeviceActionRequest(
        ...
        text_transport=raw.pop("text_transport", None),
        text_scope=TextTransportActionScope(**scope) if isinstance(scope, dict) else scope,
        launch_ref=raw.pop("launch_ref", None),
