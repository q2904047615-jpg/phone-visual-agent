...
class RetiredExperimentToolsTests(unittest.TestCase):
    ...
    def test_current_regressions_and_useful_tools_are_preserved(self):
        for relative in (
            'test_flat_observation_contract.py', 'test_point_scene_projection.py',
            'test_approved_restriction_choices.py', 'test_post_action_authority.py',
            'test_adb_only_text_contract.py', 'eval_qwen_visual_decision.py',
