...
class SingleStepGenericSceneObserverTests(unittest.TestCase):
    ...
    def test_element_swipe_axis_grid_points_normalize_with_current_image_height(self) -> None:
        ...
        self.assertEqual([180, 680], decision["start"])
        self.assertEqual([500, 680], decision["end"])
    ...
    def test_direct_tap_point_normalizes_independently_from_coarse_bounds_across_layouts(self) -> None:
        cases = (
            ("com.tencent.mm", "chat_list", 1000, [50, 320, 950, 451], [500, 220]),
            ("com.android.settings", "settings_home", 1000, [80, 384, 920, 480], [240, 417]),
        )
